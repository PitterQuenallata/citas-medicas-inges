...
// NUEVO: Form Request para actualización de horarios médicos
class UpdateHorarioRequest extends FormRequest
{
    ...
    /**
     * Devuelve el ID del horario actual desde el route model binding
     * para excluirlo de la validación de solapamiento en el controlador.
     */
    public function horarioActualId(): ?int
    {
        return $this->route('horario')?->id_horario;
    }
