...
<div class="card flex flex-col items-center justify-center py-16 text-center">
    ...
    <h2 class="text-xl font-semibold text-slate-700 dark:text-navy-100">Detalle Historial Clinico</h2>
    ...
    <a href="{{ route('historial.index') }}" class="mt-6 btn border border-slate-300 px-5 text-sm hover:bg-slate-100">Volver</a>
</div>
@endsection
