        ...
        <table class="is-hoverable w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                    ...
                    <td class="whitespace-nowrap px-3 py-3 sm:px-5 text-slate-600 dark:text-navy-200">{{ $especialidad->descripcion ?? '—' }}</td>
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-5 py-8 text-center text-slate-400 dark:text-navy-300">
