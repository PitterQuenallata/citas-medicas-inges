...
<div class="container py-4">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h1 class="h3 mb-0">Editar Médico</h1>
            <p class="text-muted mb-0">
                {{ $medico->apellidos }}, {{ $medico->nombres }}
                <span class="badge bg-secondary font-monospace fw-normal ms-1">{{ $medico->codigo_medico }}</span>
            </p>
        </div>
    </div>

    <form action="{{ route('medicos.update', $medico->id_medico) }}" method="POST" id="formMedico">
        @csrf
        @method('PUT')
                        ...
                        <div class="row g-3">
                                ...
                                <select name="id_usuario" class="form-select @error('id_usuario') is-invalid @enderror" required>
                                    ...
                                    @foreach($usuariosDisponibles as $usuario)
                                        <option value="{{ $usuario->id_usuario }}"
                                            {{ old('id_usuario', $medico->id_usuario) == $usuario->id_usuario ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="codigo_medico"
                                       ...
                                       value="{{ old('codigo_medico', $medico->codigo_medico) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nombres"
                                       ...
                                       value="{{ old('nombres', $medico->nombres) }}" maxlength="100" required>
                                @error('nombres')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="apellidos"
                                       ...
                                       value="{{ old('apellidos', $medico->apellidos) }}" maxlength="100" required>
                                @error('apellidos')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="ci"
                                       ...
                                       value="{{ old('ci', $medico->ci) }}" maxlength="20">
                                @error('ci')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="telefono"
                                       ...
                                       value="{{ old('telefono', $medico->telefono) }}" maxlength="20">
                                @error('telefono')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" name="email"
                                       ...
                                       value="{{ old('email', $medico->email) }}" maxlength="150">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="matricula_profesional"
                                       ...
                                       value="{{ old('matricula_profesional', $medico->matricula_profesional) }}"
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" name="horarios[{{ $idx }}][duracion_cita_minutos]"
                                               class="form-control form-control-sm"
                                               value="{{ $horario->duracion_cita_minutos }}" min="5" max="240">
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        <p class="text-muted small mb-0 {{ $medico->horarios->count() > 0 ? 'd-none' : '' }}" id="mensajeSinHorarios">
                        ...
                        @forelse($especialidades as $esp)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                       ...
                                       {{ in_array($esp->id_especialidad, old('especialidades', $especialidadesSeleccionadas)) ? 'checked' : '' }}>
