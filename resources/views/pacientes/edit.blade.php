        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <label class="block">
                ...
                <input type="date" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $paciente->fecha_nacimiento) }}"
                    required
                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('fecha_nacimiento') border-error @enderror" />
            ...
            <label class="block">
                ...
                <select name="sexo" required
                    class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('sexo') border-error @enderror">
                    <option value="" {{ old('sexo', $paciente->sexo) === null ? 'selected' : '' }} disabled>Seleccionar...</option>
            ...
            <label class="block sm:col-span-2">
                ...
                <input type="text" name="direccion" value="{{ old('direccion', $paciente->direccion) }}"
                    required
                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('direccion') border-error @enderror" />
            ...
            <label class="block">
                ...
                <input type="text" name="grupo_sanguineo" value="{{ old('grupo_sanguineo', $paciente->grupo_sanguineo) }}"
                    required
                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('grupo_sanguineo') border-error @enderror" />
            ...
            <label class="block">
                ...
                <input type="text" name="contacto_emergencia_nombre" value="{{ old('contacto_emergencia_nombre', $paciente->contacto_emergencia_nombre) }}"
                    required
                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('contacto_emergencia_nombre') border-error @enderror" />
            ...
            <label class="block">
                ...
                <input type="text" name="contacto_emergencia_telefono" value="{{ old('contacto_emergencia_telefono', $paciente->contacto_emergencia_telefono) }}"
                    required
                    class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('contacto_emergencia_telefono') border-error @enderror" />
            ...
            <label class="block sm:col-span-2">
                ...
                <textarea name="alergias" rows="3" required
                    class="form-textarea mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('alergias') border-error @enderror">{{ old('alergias', $paciente->alergias) }}</textarea>
            ...
            <label class="block sm:col-span-2">
                ...
                <textarea name="observaciones_generales" rows="3" required
                    class="form-textarea mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('observaciones_generales') border-error @enderror">{{ old('observaciones_generales', $paciente->observaciones_generales) }}</textarea>
