        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <label class="block">
                ...
                <select name="sexo" required
                    ...
                    <option value="" {{ old('sexo') === null ? 'selected' : '' }} disabled>Seleccionar...</option>
            ...
            <label class="block">
                ...
                <input type="text" name="grupo_sanguineo" value="{{ old('grupo_sanguineo') }}"
                    required
            ...
            <label class="block">
                ...
                <input type="text" name="contacto_emergencia_nombre" value="{{ old('contacto_emergencia_nombre') }}"
                    required
            ...
            <label class="block">
                ...
                <input type="text" name="contacto_emergencia_telefono" value="{{ old('contacto_emergencia_telefono') }}"
                    required
            ...
            <label class="block sm:col-span-2">
                ...
                <textarea name="alergias" rows="3" required
                    class="form-textarea mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('alergias') border-error @enderror">{{ old('alergias') }}</textarea>
            ...
            <label class="block sm:col-span-2">
                ...
                <textarea name="observaciones_generales" rows="3" required
                    class="form-textarea mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 focus:border-primary focus:outline-none dark:border-navy-450 dark:bg-navy-700 dark:text-navy-100 @error('observaciones_generales') border-error @enderror">{{ old('observaciones_generales') }}</textarea>
