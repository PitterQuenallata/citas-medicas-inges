...
<div class="card max-w-2xl p-4 sm:p-5">
    <h3 class="text-base font-medium text-slate-700 dark:text-navy-100 mb-6">Editar Usuario</h3>
    <form method="POST" action="{{ route('usuarios.update', $usuario->id) }}" class="space-y-4">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <label class="block sm:col-span-2">
                <span class="text-sm font-medium text-slate-600 dark:text-navy-100">Nueva contraseña</span>
