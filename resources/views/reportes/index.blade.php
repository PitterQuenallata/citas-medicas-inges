@extends('layouts.app')
@section('title', 'Reportes del Reportes')
@section('content')
<div class="card flex flex-col items-center justify-center py-16 text-center">
    ...
    <h2 class="text-xl font-semibold text-slate-700 dark:text-navy-100">Reportes del Reportes</h2>
    ...
    <a href="{{ route('reportes.index') }}" class="mt-6 btn border border-slate-300 px-5 text-sm hover:bg-slate-100 dark:border-navy-450 dark:hover:bg-navy-600">Volver</a>
</div>
@endsection
