...
<div class="flex items-center justify-between pb-4">
    <div class="flex items-center gap-2">
        ...
        <h2 class="text-lg font-medium text-slate-700 dark:text-navy-100">Nueva Cita</h2>
    </div>
</div>
...
<div class="card px-4 py-5 sm:px-5">
    <form method="POST" action="{{ route('citas.store') }}" id="form-cita">
        ...
        <div class="mt-6 flex justify-end gap-3">
            <a href="{{ route('citas.index') }}" class="btn border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500">
                Cancelar
            </a>
