    ...
    <div
        ...
        <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
            ...
            <a href="{{ route('citas.index') }}"
                class="flex size-11 items-center justify-center rounded-lg outline-hidden transition-colors duration-200 {{ request()->routeIs('citas.*') || request()->routeIs('agenda') ? 'bg-primary/10 text-primary dark:bg-navy-600 dark:text-accent-light' : 'hover:bg-primary/20 focus:bg-primary/20 dark:hover:bg-navy-300/20' }}"
            ...
            <a href="{{ route('medicos.index') }}"
                ...
                x-tooltip.placement.right="'Médicos'">
                <svg class="size-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
